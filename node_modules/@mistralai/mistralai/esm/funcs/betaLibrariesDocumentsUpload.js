...
async function $do(client, request, options) {
    ...
    if (isBlobLike(payload.RequestBody.file)) {
        ...
        const contentType = getContentTypeFromFileName(payload.RequestBody.file.fileName)
            || "application/octet-stream";
        appendForm(body, "file", new Blob([new Uint8Array(payload.RequestBody.file.content).buffer], {
            type: contentType,
        ...
        const contentType = getContentTypeFromFileName(payload.RequestBody.file.fileName)
            || "application/octet-stream";
        appendForm(body, "file", new Blob([payload.RequestBody.file.content], { type: contentType }), payload.RequestBody.file.fileName);
    }
    const pathParams = {
