 ...
 */
export function betaLibrariesList(client, options) {
...
async function $do(client, options) {
    ...
    const [result] = await M.match(M.json(200, components.ListLibrariesResponse$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req);
    if (!result.ok) {
